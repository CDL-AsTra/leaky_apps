...
var (
	...
	keyPat = regexp.MustCompile(`\b(ey[a-zA-Z0-9]{17,}\.ey[a-zA-Z0-9\/\\_-]{17,}\.(?:[a-zA-Z0-9\/\\_-]{10,}={0,2})?)\b`)
)
...
func (s Scanner) Description() string {
	return "Uncovered a JSON Web Token, which may lead to unauthorized access to web applications and sensitive user data."
}
