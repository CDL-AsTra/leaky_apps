...
var (
	...
	keyPat = regexp.MustCompile(detectors.PrefixRegex([]string{"lob"}) + `\b((live|test)_([a-f0-9]{35}|[a-f0-9]{31}))\b`)
)
...
func (s Scanner) Type() detectorspb.DetectorType {
	return detectorspb.DetectorType_Lob_gitleaks
}

func (s Scanner) Description() string {
	return "Uncovered a Lob API Key, which could lead to unauthorized access to mailing and address verification services."
}
