...
var (
	...
	keyPat = regexp.MustCompile(`\b((pat|sat)\.[a-zA-Z0-9_-]{22}\.[a-zA-Z0-9]{24}\.[a-zA-Z0-9]{20})\b`)
)
...
func (s Scanner) Description() string {
	return "Identified a Harness Access Token (PAT or SAT), risking unauthorized access to a Harness account."
}
