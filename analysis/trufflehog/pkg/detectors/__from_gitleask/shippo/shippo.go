...
var (
	...
	keyPat = regexp.MustCompile(`\b(shippo_(live|test)_[a-f0-9]{40})\b`)
)
...
func (s Scanner) Description() string {
	return "Discovered a Shippo API token, potentially compromising shipping services and customer order data."
}
